export const toggleSwitchTheme = {
    ...
    "toggle": {
        "base": "relative adbc rounded-full border after:absolute after:rounded-full after:bg-white after:transition-all group-focus:ring-4 group-focus:ring-cyan-500/25",
        "checked": {
        ...
        "sizes": {
            "sm": "h-5 w-9 min-w-9 after:left-[2px] after:top-[2px] after:h-4 after:w-4 rtl:after:right-px",
