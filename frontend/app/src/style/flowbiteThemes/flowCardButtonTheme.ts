export const flowCardButtonTheme = {
    "base": "w-full group relative flex items-stretch justify-center text-center font-medium transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow] focus:z-10 focus:outline-none",
    "fullSized": "w-full",
    "color": {
        ...
        "info": "border-solid border-border-color bg-transparent text-light-gray-text enabled:hover:border-message-card-accent dark:bg-cyan-600 dark:focus:ring-cyan-800 dark:enabled:hover:bg-cyan-700",
